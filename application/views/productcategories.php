...
?>
 ...
 <div id="content">
  ...
  <h2 title="<?= $product_name[0]['name']; ?>" class="pro_name_sub"> <?= $product_name[0]['name']; ?> </h2>
 ...
 $img = $this->Mymodel->get_prod_img($id);

 $img_path = $img[0]['image_urls'];
 ...
 <a title="<?= $value['name'];?>" href="<?php echo base_url().$value['page_url']; ?>"><img src="<?= base_url().$img; ?>" title="<?= $value['name'];?>" alt="Product image" class="product-image_cl"></a>
