                        ...
                        <div class="product-top">
                           ...
                           <figure class="owl-carousel product-slider">
                              ...
                              <?php  $image_json = str_replace(array("\t","\n"), "", $value['image_urls']);
                                ...
                                <img  src="<?php echo base_url(); ?><?php if($product_img == ""){ echo "assets/images/products/image_not_found.jpg" ;} else { echo $product_img; } ?>" alt="Product image" class="product-image">
                              </a>
                           </figure>
                        </div>
                        <!-- End .product-top -->
