...
<div id="account" style="margin-top:30px; margin-bottom:30px;" class="container container1 account_page">
    <div class="row">
        <div class="col-md-6">
            <div id="sign_in_div" class="sign_in_div" style="margin-top: 148px; margin-left: 192px;">
            ...
            <form id="sign_in_form" class="sign_in_form_1" method="post" action=<?php echo base_url().'check-login';?>>
                <h1>Sign In</h1>
        ...
        <div class="col-md-6">
            <div id="sign_up_btn" class="sign_up_btn" style="margin-top: 148px; margin-left: 192px;">
            ...
            <form id="sign_up_form" class="sign_up_form" method="POST" action="<?= base_url().'insert-user-data'; ?>">
                ...
                <input class="input" Required id="name" type="text" placeholder="Enter Your Name" name="name" required>


                <label for="email"><b>Company Name <span style="color:red">*</span></b></label>
                <p class="error_cl" id="c_name_err"></p>
                <input class="input" Required id="c_name" type="text" placeholder="Enter Company Name" name="company_name" >


                <label for="email"><b>Email <span style="color:red">*</span></b></label>
                <p class="error_cl" id="email_error"></p>
                <input style="margin-bottom: 9px;" Required class="input" id="email" type="text" placeholder="Enter Your Email" name="email" >
    ...
    margin-bottom: 20px;">
                    ...
                    <input Required id="myInput" type="text" name="myCountry" value="<?php
                ...
                <input class="input" Required type="password" id="password" placeholder="Enter Password" name="password" >


                <label for="psw"><b>Confirm Password <span style="color:red">*</span></b></label>
                <p class="error_cl" id="c_password_err"></p>
                <input class="input" Required type="password" id="c_password" placeholder="Enter Password" name="password" >
        ...
        $(document).ready(function() {
            ...
            $('#sub_btn').click(function(){
                ...
                if(name == ""){
                    ...
                    $("#name").css({"border": "1px solid firebrick", "box-shadow": "0px 0px 8px firebrick"});
                    var flag = false;
                }
                else{
                    $('#name_err').html('');
                    $("#name").css({"border": "1px solid mediumseagreen", "box-shadow": "0px 0px 8px mediumseagreen"});
                }
                if(c_name == ""){
                    $('#c_name_err').html('Enter Company Name');
                    $("#c_name").css({"border": "1px solid firebrick", "box-shadow": "0px 0px 5px firebrick"});
                    var flag = false;
                }
                else{
                    $('#c_name_err').html('');
                    $("#c_name").css({"border": "1px solid mediumseagreen", "box-shadow": "0px 0px 5px mediumseagreen"});
                }

                if(myInput == ""){
                    $('#myInput_err').html('Enter Country Name');
                    $("#myInput").css({"border": "1px solid firebrick", "box-shadow": "0px 0px 8px firebrick"});
                    var flag = false;
                }
                else{
                    $('#myInput_err').html('');
                    $("#myInput").css({"border": "1px solid mediumseagreen", "box-shadow": "0px 0px 5px mediumseagreen"});
                }

                if(email == ""){
                    $('#email_error').html('Enter Email');
                    $("#email").css({"border": "1px solid firebrick", "box-shadow": "0px 0px 8px firebrick"});
                    var flag = false;
                }
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if(response == 1){
                                ...
                                $('#email_error').html('');
                                $("#email").css({"border": "1px solid mediumseagreen", "box-shadow": "0px 0px 5px mediumseagreen"});
                                return true;
                            }
                        }
                    })
                ...
                if(password == ""){
                    ...
                    $("#password").css({"border": "1px solid firebrick", "box-shadow": "0px 0px 8px firebrick"});
                    var flag = false;
                }
                else{
                    $('#password_err').html('');
                    $("#password").css({"border": "1px solid mediumseagreen", "box-shadow": "0px 0px 5px mediumseagreen"});
                }
                if(c_password == ""){
                    $('#c_password_err').html('Enter Confirm Password');
                    $("#c_password").css({"border": "1px solid firebrick", "box-shadow": "0px 0px 8px firebrick"});
                    var flag = false;
                }
                    ...
                    $('#c_password_err').html('');
                    $("#c_password").css({"border": "1px solid mediumseagreen", "box-shadow": "0px 0px 5px mediumseagreen"});
                }
            ...
            $('#sign_in_ch').click(function(){
                ...
                if(email == ""){
                    ...
                    $('#s_email_err').html('');
                    $('#s_email_err').append('Enter Correct Email Like- <span style="color:green; font-style:italic; font-weight:400; font-size:15px; text-decoration:underline">yourname@example.com </span> ');
                    flag = false;
                }
                else{
                    $('#s_email_err').html('');
