...
<!-- /font files -->
<!-- css files -->
<link href="<?php echo base_url(); ?>assets/css/page_style.css" rel="stylesheet" type="text/css" media="all" />
<!-- /css files -->
<!-- js files -->
...
<div class="container demo-2">
	<div class="content">
        <div id="large-header" class="large-header">
			...
			<img src="<?php echo base_url(); ?>assets/images/owl.gif" alt="flashy" class="w3l">
...
<script src="<?php echo base_url(); ?>assets/js/demo-2.js"></script>
<!-- /js files -->
</body>
</html>
