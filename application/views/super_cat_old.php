      ...
      <div id="wrapper">
       ...
       <div class="container addcldis1">
          <h2 class="margsub" align="center">Range Of <?php echo str_replace('-',' ',$bred_array['1']); ?></h2>
             ...
             ?>
             <div class="col-md-2 container1" style="margin-bottom: 70px;">
               <a href="<?= base_url().$new_value['cpage_url']; ?>">
                <img src="<?php echo base_url().$product_img; ?>" alt="Avatar" class="image img-thumbnail">
                  <div class="overlay">
                    <div class="text" style="width: 210px;
...
font-size: 15px;"><?= $new_value['cat_name']; ?></div>
                </div>
                <!-- <div class="caption">
