    ...
    <div class="container table-responsive">
        ...
        <table class="table table-bordered table-striped table-hover table-condensed table-responsive mt30">
            ...
            if ($products) {
                ...
                echo '<tr><th style="width: 22%; text-align:center;vertical-align: middle;background: #006fab;color: #FFFFFF;">Compare  ' . count($products) . ' Items</th>';
                foreach ($products as $product) {
                    ...
                    echo '<a style="font-size: 15px; color: #020202bd; font-weight: 600;" href="' . base_url($product['page_url']) . '">' . $product['name'] . '</a>';
                    echo '</td>';
                }
                echo '</tr>';
            }?>
