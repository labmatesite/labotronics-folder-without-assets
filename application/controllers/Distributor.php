...
class Distributor extends CI_Controller{
    ...
    $msg_body1  = '
    <h2 style="text-align:center">New Distributor Request : Labotronics </h2>
...
$this->email->from('info@labotronics.com', 'Labotronics - Account Registration');
...
$this->email->from('info@labotronics.com', 'Labotronics - Reset Password');
$this->email->to($email);

$this->email->subject('Reset Password');
$this->email->message('<h2>Labotronics Scientific Ltd Verify Your Account</h2><br><br>
...
$this->load->view('otp',$data);
    ...
    $this->email->from('info@labotronics.com', 'Labotronics - Update Password');
    $this->email->to($this->session->userdata('User_email'));
    $this->email->subject('Update Password');
    $this->email->message('<h2>Labotronics Scientific Ltd</h2><br>
    <h4 style="color:Teal">Labotronics will inform you that your password has been successfully updated </h4><br>
');
